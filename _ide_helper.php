...
')
     ...
     */ 
        ...
        {
                        /** @var \MattLibera\LivewireFlash\LivewireFlashNotifier $instance */
         ...
         * @static 
         */ 
        public static function overlay($message = null, $title = null)
        {
                        /** @var \MattLibera\LivewireFlash\LivewireFlashNotifier $instance */
         ...
         * @static 
         */ 
        public static function dismissable($dismissable = true)
        {
                        /** @var \MattLibera\LivewireFlash\LivewireFlashNotifier $instance */
                        return $instance->dismissable($dismissable);
        }
                    /**
         ...
         * @static 
         */ 
        public static function notDismissable()
        {
                        /** @var \MattLibera\LivewireFlash\LivewireFlashNotifier $instance */
                        $instance->notDismissable();
        }
                    /**
        ...
        public static function macro($name, $macro)
        {
                        \MattLibera\LivewireFlash\LivewireFlashNotifier::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \MattLibera\LivewireFlash\LivewireFlashNotifier::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \MattLibera\LivewireFlash\LivewireFlashNotifier::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {
                        \MattLibera\LivewireFlash\LivewireFlashNotifier::flushMacros();
        }
...
namespace  { 
            ...
            class LivewireFlash extends \MattLibera\LivewireFlash\LivewireFlash {}
